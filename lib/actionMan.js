/*
 * Copyright (C) 2018 Jaroslav Peter Prib
 * 
 ...
 *  
 *  
  	function resolveActionStack(workArea) {
		return new Promise(function(resolve, reject) {
			workArea.resolve = resolve;
			workArea.reject = reject;
			alasql.drunStmt(workArea);
		});
	}
	async function asyncSubTasks(workArea) {
		return await resolveActionStack(workArea);
	}
	res=asyncSubTasks(workArea);
